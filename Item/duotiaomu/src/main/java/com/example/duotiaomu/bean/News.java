...
public class News {
    ...
    public static class DataBean implements MultiItemEntity {
        ...
        public int getItemType() {
            if (getThumbnail_pic_s()!=null&&getThumbnail_pic_s02()==null&&getThumbnail_pic_s03()==null){
                return TEXT;
            }else if (getThumbnail_pic_s()!=null&&getThumbnail_pic_s02()!=null&&getThumbnail_pic_s03()!=null){
                return IMG;
            }else {
                return TEXT;
            }
